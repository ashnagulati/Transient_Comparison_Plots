...
If you use data from this repository, please cite both the original sources (as listed in the accompanying `.bib` and `.RTF` files) **and** the main paper: **https://ui.adsabs.harvard.edu/abs/2026ApJ..1000..118G/abstract**.
